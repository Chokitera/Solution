...
{
    public partial class ChamadoCliente : UserControl
    {
        public ChamadoCliente()
        {
            InitializeComponent();
        }
        ...
        private void btnVisualizar_Click(object sender, EventArgs e)
        {
                ...
                {
                ((Form1)qrForm.First()).ColocarFormNoPainel(new Frmvisualizarchamados(_idChamado, _idUsuarioLogado));
                }
        }
    }
}
